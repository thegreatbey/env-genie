...
[![Publish](https://img.shields.io/github/actions/workflow/status/thegreatbey/env-genie/publish.yml?branch=main&logo=github)](https://github.com/thegreatbey/env-genie/actions/workflows/publish.yml)
